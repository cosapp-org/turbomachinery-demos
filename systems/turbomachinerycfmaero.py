...
from systems.mixershaft import MixerShaft


class TurbomachineryCFMAero(System):
    """
    Turbomachinery aero
    ...
    def setup(self):
        ...
        self.add_child(CompressorAero('boosteraero'))
        ...
        self.add_child(MixerShaft('mixershaft', n_in=1, n_out=2))

        # primery flow
        self.connect(self.fanaero.fl_out, self.bypassaero.fl0_in)
        self.connect(self.bypassaero.fl0_out, self.boosteraero.fl_in)
        self.connect(self.boosteraero.fl_out, self.gasgeneratoraero.fl_in)
        ...
        # shaft
        self.connect(self.turbineaero.shaft_out, self.mixershaft.shaft0_in)
        self.connect(self.mixershaft.shaft0_out, self.fanaero.shaft_in)
        self.connect(self.mixershaft.shaft1_out, self.boosteraero.shaft_in)

        # init
        self.bypassaero.r1 = 0.9
        self.mixershaft.r1 = 0.9

        # off design
        self.add_target('mixershaft.r0')
